...
import avatar1 from "../../assets/images/user-circle.svg"
import call from "../../assets/images/phone-outgoing.svg"
...
const Messages = () => {
    ...
    return (
        <div className="w-screen flex bg-purple-200 ">
            <div className=" border-white h-screen bg-cyan-300 overflow-y-scroll">
            ...
            <div className="w-[40%] border-2 border-white flex  flex-col items-center bg-white h-screen">
                {
            ...
            <div className=" border-2 border-white  h-screen overflow-y-scroll">
