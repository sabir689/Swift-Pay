...
const Products = () => {
  ...
  return (
    <div>
      <TitleBar title='Total Products' total={myProduct.length}/>
      {loading ? 
       <Loader/>
       : myProduct.length > 0 ? <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
     ...
     <div className="flex flex-col items-center justify-center h-full">
      <img width='30%' src="https://i.ibb.co/5RsjKcJ/6632286.webp" alt="No Products" />
      <h1 className="font-medium text-2xl text-neutral-500 mt-3">You currently have no products listed</h1>
       </div>
       }
    </div>
  );
