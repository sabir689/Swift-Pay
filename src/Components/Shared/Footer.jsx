    ...
    <div>
      <footer className="footer p-10 bg-base-200 text-base-content ">
        <nav>
          ...
          <a className="link link-hover">Gift Wrappers</a>
        </nav>
        <nav>
          <header className="footer-title">Company</header>
          <a className="link link-hover">About us</a>
          <a className="link link-hover">Contact</a>
          <a className="link link-hover">Our Fees</a>
        </nav>
        <nav>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        ...
        <div className="mt-7">
          <p className="text-xs">
            SwiftPay is a service of PayPal, Inc., a licensed provider of money
            transfer services (NMLS ID: 910457). All money <br /> transmission
