...
const Register = () => {
  ...
  const registration = (e) => {
    ...
    const confirmEmail = form.re-email.value;
      ...
      <div className='container md:w-10/12/ lg:w-2/4 mx-auto px-4'>
        <div className='bg-white px-6 py-10 rounded-lg'>
          ...
          <form onSubmit={registration}>
            ...
            <label className='text-lg font-normal text-black1 mb-1 ml-1 mt-5 block'>Confirm Gmail</label>
            <input className='text-base placeholder:text-textColor bg-sectionbg rounded-lg border duration-300 focus:bg-white focus:shadow-sm focus:border focus:border-primery outline-none py-4 px-5 w-full' placeholder='Write same gmail' name='re-email' type='email'/>
